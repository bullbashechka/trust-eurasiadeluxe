...
В текущей подборке 8 изображений, созданных встроенным image_gen по ракурсам Blender. Общие планы 00 остаются геометрическими референсами. Исходные рендеры не заменены.
